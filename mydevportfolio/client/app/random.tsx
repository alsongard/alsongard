...
//             <h2 className='text-center text-[35px]'>Skills</h2>
//             <div className='flex flex-row justify-evenly w-[80%] border-2 border-white mx-auto py-[10px] px-[20px]'>
//               <ul>
...
//               {/* tools */}
//               <ul>
//                 <li className="flex flex-row justify-between items-center h-[100px] border-2 border-sky-200 w-[500px]">      
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg" />
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original-wordmark.svg" />
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" />
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-original-wordmark.svg" />
//                 </li>
//                 <li className="flex flex-row justify-between items-center h-[100px] border-2 border-sky-200 w-[500px]">
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/express/express-original.svg" />
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original-wordmark.svg" />
//                 </li>
//                 <li className="flex flex-row justify-between items-center h-[100px] border-2 border-sky-200 w-[500px]">
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/linux/linux-original.svg" />
//                 </li>
//                 <li className="flex flex-row justify-between items-center h-[100px] border-2 border-sky-200 w-[500px]">
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/unity/unity-plain-wordmark.svg" />
//                 </li>
//                 <li className="flex flex-row justify-between items-center h-[100px] border-2 border-sky-200 w-[500px]">
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original-wordmark.svg" />
//                   <img className='w-[50px] h-[50px]' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/scikitlearn/scikitlearn-original.svg" />
//                 </li>
//               </ul>
//             </div>
