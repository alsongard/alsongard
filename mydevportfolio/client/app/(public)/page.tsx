...
export default function Home() {
	...
	return (
		<main className="w-screen bg-white dark:bg-black border-b-2 border-black">
			{/* IMAGE CONTAINER */}
			<div className="flex h-full flex-row max-sm:flex-col max-sm:items-center bg-white dark:bg-black items-start justify-evenly gap-x-[30px] my-[50px] w-[90%] mx-auto  py-[70px]  ">
