...
export default function Home() {
  return (
    <main className="w-[100vw] bg-white dark:bg-black border-b-2 border-black">
      {/* IMAGE CONTAINER */}
      <div className="flex flex-row bg-white dark:bg-black items-start justify-evenly gap-x-[30px] my-[50px] w-[90%] mx-auto  py-[70px]  ">
        <div className="">
          <Image className="rounded-[100%]" width={450}  height={550} src="/images/anime_2.jpg" alt=""/>
        </div>

        <div className='pt-[50px] pl-[5px] dark:text-white '>
          ...
          {/* icons */}
          <div className='flex flex-row justify-evenly border-2 mx-auto py-[10px]  w-1/2 border-black dark:border-white rounded-[50px]'>
            <div className='h-[30px] w-[30px]  rounded-[100%] hover:scale-[1.4]  ease-in-out'>
              <a href="http://github.com/alsongard" target="_blank">
                <FaGithub className='h-[100%] w-[100%] rounded-[100%] hover:text-black  dark:bg-sky-500'/>
            ...
            <div className='h-[30px] w-[30px]  rounded-[100%] hover:scale-[1.4] h ease-in-out'>
              <a href="mailto:alsongadizo@gmail.com" target="_blank">
                <BiLogoGmail className='h-[100%] w-[100%] rounded-[100%] hover:text-black  dark:bg-sky-500'/>
              </a>
            </div>
            ...
            <div className='h-[30px] w-[30px]  rounded-[100%] hover:scale-[1.4] hover:black  ease-in-out'>
              <a href="https://x.com/alsongadizo" target="_blank">
                <FaTwitter className='h-[100%] w-[100%] rounded-[100%] hover:text-black  dark:bg-sky-500'/>
              </a>
            </div>
          </div>
